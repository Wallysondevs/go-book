    ...
    <>
      ...
      >
        <div className="p-3 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2 lg:hidden">
          <span className="font-bold text-go-cyan-dark dark:text-go-cyan">Menu</span>
        ...
        <div className="p-3 sticky top-0 bg-white dark:bg-slate-900 z-10">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-2 py-1.5 text-sm bg-slate-100 dark:bg-slate-800 rounded border border-transparent focus:border-go-cyan focus:outline-none"
            />
          </div>
        </div>
          ...
          {filtered.map((s) => {
            ...
            return (
              <div key={s.id} className="mb-1">
                ...
                >
                  <Icon size={16} className="text-go-cyan-dark dark:text-go-cyan" />
                        ...
                        <li key={slug}>
                          <Link
                            ...
                            className={`block pl-3 pr-2 py-1.5 text-sm border-l-2 -ml-px transition-colors ${
                              active
                                ? "border-go-cyan text-go-cyan-dark dark:text-go-cyan font-semibold bg-go-cyan/10"
                                : "border-transparent text-slate-600 dark:text-slate-400 hover:text-go-cyan-dark hover:border-go-cyan/30"
                            }`}
                          >
                            {c.title}
                          </Link>
